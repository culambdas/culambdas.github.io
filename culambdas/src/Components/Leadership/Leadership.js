...
export default class Leadership extends Component {
  ...
  componentDidMount() {
      ...
      const vpe = {
        ...
        "mil-dollars": "I'd pay off my college tuition and give the rest to my parents.",
        "fun-fact": "I played basketball overseas in Europe.",
        "advice": "Make meaningful relationships as they are the most important part of your growth as an individual in and outside of college.",
      ...
      const president = {
        ...
        "dream-ride": "Yoshi",
        "fav-quote": "\"You have to think anyway, so why not think big? - Donald J. Trump",
        "mil-dollars": "Court-side seats at the NBA finals",
        "fun-fact": "I know the names of every country in the world",
        "advice": "Put time into the people you really care about. Don't get caught into thinking you have to be friends with someone just because it is convenient.",
        "why-join": "I wanted a family that would always push each other to their fullest abilities. Also the boyssssss",
        "prev-chapter": "",
        "name": "Simon \"Apex\" Liu",
        "main-img": "Apex.png",
        "modal-img": "Apex.png",
      ...
      const vpi = {
        ...
        "fav-quote": "\"Why waste time use lot word when few word do trick?\" - Kevin Malone",
        "mil-dollars": "I'd buy some cars",
        "fun-fact": "I'm a giant",
        "advice": "Enjoy your time in college while it lasts or something",
        "why-join": "For the sense of brotherhood and to develop lasting relationships socially and professionally",
        "prev-chapter": "",
      ...
      const treasurer = {
        ...
        "dream-ride": "Lapras",
        "fav-quote": "\"Stop worrying so much and start having fun!\" - My high school English teacher",
        "mil-dollars": "Buy my dog a lot of treats. Buy a lot of bubble tea. Become the greatest Pokémon trainer of all time.",
        "fun-fact": "I have a Tibetan Mastiff that weighs almost as much as me.",
        "advice": "Make sure you study but don't let it get in the way of new experiences.",
      ...
      this.setState({eboard_list: [[secretary, 3, "Secretary"], [vpe, 4, "Vice President External"], [president, 4, "President"], [vpi, 5, "Vice President Internal"], [treasurer, 3, "Treasurer"]]}); // keep this order. the second part in each element is the 0-indexed index of bro in his class
  }

  openInfoModal(event) {
    if (!isNaN(parseInt(event.target.id))) {
        const index = parseInt(event.target.id);
      this.setState({ activeBro: this.state.eboard_list[index][1], activeClass: this.state.eboard_list[index][0].class }, () => {
        ...
        <div className="members-hero">
          <div className="active-house-image">
            <div className="members-image-text">
              <h1>Fall 2021 </h1> <h1> Executive Board</h1>
            </div>
          </div>
                      ...
                      <div>
                        ...
                        <div className="roster-photo">
                            ...
                            src={
                                ...
                                e[0]['main-img'] ? e[0]['main-img'] : 'default.png'
                                }`).default
                            }
                            />
                        </div>
